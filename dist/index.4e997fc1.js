...
function result11() {
    ...
    let valor;
    let i;
    if (numberA < numberB) valor = numberA;
    else valor = numberB;
    for(i = 2; i < valor / 2; i++)if (numberA % i === 0 && numberB % i === 0) text11.innerHTML = `Son divisible entre: ${i}`;
}

//# sourceMappingURL=index.4e997fc1.js.map

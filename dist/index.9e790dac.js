...
function findPrimeNumber() {
    ...
    if (numero % 2 == 0) text12.innerHTML = `El número : ${numero} no es primo`;
    if (numero % 2 != 0) text12.innerHTML = `El número : ${numero} es primo`;
}

//# sourceMappingURL=index.9e790dac.js.map
